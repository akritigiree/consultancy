...
// ✅ Import your appointment form here (keep at top)
  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* ✅ Add your appointment form route here */}
        <Route
          path="appointments/new"
          element={
            <ProtectedRoute allowedRoles={['client', 'student']}>
              <AppointmentForm />
            </ProtectedRoute>
          }
        />
